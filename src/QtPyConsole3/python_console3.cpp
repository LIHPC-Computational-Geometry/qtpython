...
*/
		...
		ConsoleOutput::cout ( ) << "Version QtPython : "
		     << QtPython::getVersion ( ).getVersion ( ) << co_endl;

		QApplication		app (argc, argv);
		QtPython3InterpretorMainWindow*	window	= new QtPython3InterpretorMainWindow (0, true);
